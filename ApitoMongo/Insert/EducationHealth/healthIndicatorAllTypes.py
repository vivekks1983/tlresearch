...
csvfile = open('/home/ubuntu/project/ApiToMongo/Insert/LG/data/PublicHealthOutcomesFramework.csv', 'r')
reader = csv.DictReader( csvfile )
mongo_client=MongoClient() 
db=mongo_client.test
db.PublicHealthOutcomes.drop()
...
for each in reader:
    ...
    db.PublicHealthOutcomes.insert(row)
